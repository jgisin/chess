...
class Game
	def initialize
	  ...
	  b.board[1][0] = [@rw1 = Rook.new(1,0,"W"), @nw1 = Knight.new(1,1,"W"),
	  				   @bw1 = Bishop.new(1,2,"B"), @qw1 = Queen.new(1,3,"W"), 'K', @bw2 = Bishop.new(1,5,"W"),
	  ...
	  b.board[8][0] = [@rb1 = Rook.new(8,0,"B"), @nb1 = Knight.new(8,1,"B"),
	  				   @bb1 = Bishop.new(8,2,"B"), @qb1 = Queen.new(8,3,"B"), 'K', @bb2 = Bishop.new(8,5,"B"),
	  				   @nb2 = Knight.new(8,6,"B"), @rb2 = Rook.new(8,7,"B")] 
	end
	attr_reader :b
	attr_accessor :pw1, :pw2, :pw3, :pw4, :pw5, :pw6, :pw7, :pw8
	attr_accessor :rw1, :rw2, :nw1, :nw2, :bw1, :bw2, :qw1
	attr_accessor :pb1, :pb2, :pb3, :pb4, :pb5, :pb6, :pb7, :pb8
	attr_accessor :rb1, :rb2, :nb1, :nb2, :bb1, :bb2, :qb1
end

g = Game.new


g.b.move_piece(g.qb1, 6, 5)
g.b.display_board